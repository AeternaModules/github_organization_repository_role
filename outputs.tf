output "organization_repository_roles_id" {
  ...
  value       = { for k, v in github_organization_repository_role.organization_repository_roles : k => v.id if v.id != null && length(v.id) > 0 }
}
output "organization_repository_roles_base_role" {
  ...
  value       = { for k, v in github_organization_repository_role.organization_repository_roles : k => v.base_role if v.base_role != null && length(v.base_role) > 0 }
}
output "organization_repository_roles_description" {
  ...
  value       = { for k, v in github_organization_repository_role.organization_repository_roles : k => v.description if v.description != null && length(v.description) > 0 }
}
output "organization_repository_roles_name" {
  ...
  value       = { for k, v in github_organization_repository_role.organization_repository_roles : k => v.name if v.name != null && length(v.name) > 0 }
}
output "organization_repository_roles_permissions" {
  ...
  value       = { for k, v in github_organization_repository_role.organization_repository_roles : k => v.permissions if v.permissions != null && length(v.permissions) > 0 }
}
output "organization_repository_roles_role_id" {
  ...
  value       = { for k, v in github_organization_repository_role.organization_repository_roles : k => v.role_id if v.role_id != null }
}
